"""
Router — Per-User HBase Fast Lookups.
...
from config import HBASE_HOST, HBASE_PORT, TABLE_EVENT_LEDGER, TABLE_VELOCITY
from hbase_pool import decode_counter, get_salt, reverse_ts_to_human
