...
This file is intentionally thin.  All business logic lives in dedicated modules:
  state.py          — global in-memory counters / dedup sets
  ws_manager.py     — WebSocket ConnectionManager singleton
  scanners/ledger.py   — delta ledger scanner (every 1 s)
  scanners/counters.py — velocity + risk counter scanner (every 2 s)
  routers/metrics.py   — GET /api/metrics/* (in-memory reads)
  routers/users.py     — GET /api/user/* (HBase direct lookups)
...
from scanners.ledger   import ledger_scanner_loop
from scanners.counters import counter_scanner_loop
from routers           import metrics as metrics_router
from routers           import users   as users_router
from ws_manager        import manager
from state             import minute_revenue, user_totals, device_counts
